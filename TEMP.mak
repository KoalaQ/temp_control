...
FILES = delay.o time.o key.o lcd.o main.o timertask.o max6675.o out.o uart.o eeprom.o 
...
lcd.o:	lcd.c
	$(CC) -c $(CFLAGS) lcd.c
main.o: D:\iccv7avr\include\iom128v.h .\main.h .\lcd.h .\time.h .\key.h .\delay.h .\timertask.h .\eeprom.h
main.o:	main.c
	$(CC) -c $(CFLAGS) main.c
